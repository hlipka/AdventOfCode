...
function simulate(damage, armor) {
    ...
    // since we attack first, as long as we would lose in the same round we still win
...
// 219 is too high
console.log("worst rig:",bestCost);