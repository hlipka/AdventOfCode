...
public class Day232
{
    ...
    public static void main(String[] args)
    {
        try
        {
            List<List<String>> fieldData = AocDataFileUtils.getLinesAsCharStrings("2022", "day23");
...
//                dumpElves(elves);
    ...
    private static boolean simulateRound(int round, List<Elf> elfs)
    {
